...
\<<span className="magenta">hash-func-type</span>>\<<span className="green">digest-length</span>>\<<span className="blue">digest-value</span>>

with:

- <span className="magenta">hash-func-type</span> ([unsigned variable integer](#unsigned-varint)):
...
For example <span className="magenta">12</span><span className="green">20</span><span className="blue">41dd7b6443542e75701aa98a0c235951a28a0d851b11564d20022ab11d2589a8</span> is a sha2-256 hash with a length of 32 bytes.
...
\<<span className="magenta">hr-mbc</span>>-\<<span className="green">hr-cid-version</span>>-\<<span className="blue">hr-mc</span>>-\<<span className="red">hr-mh</span>>

with:

- <span className="magenta">hr-mbc</span>: the multibase code
...
\<<span className="magenta">mb-prefix</span>>\<<span className="green">cid-version</span>>\<<span className="blue">mc-ct</span>>\<<span className="red">mh-ca</span>>

with:

- <span className="magenta">mb-prefix</span> ([multibase code](#multibase)): the
  multibase prefix
