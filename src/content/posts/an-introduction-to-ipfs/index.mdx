...
\<<span class="purple">hash-func-type</span>>\<<span class="green">digest-length</span>>\<<span class="blue">digest-value</span>>

with:

- <span class="purple">hash-func-type</span> ([unsigned variable integer](#unsigned-varint)):
...
- <span class="green">digest-length</span> ([unsigned variable integer](#unsigned-varint)):
  the length of the hash, in bytes.
- <span class="blue">digest-value</span> (hash): the hash itself.

For example <span class="">12</span><span class="green">20</span><span class="blue">41dd7b6443542e75701aa98a0c235951a28a0d851b11564d20022ab11d2589a8</span> is a sha2-256 hash with a length of 32 bytes.
...
To encode a number (for example <span class="accent">37 334</span>) you would convert it to binary (<span class="accent">0b1001 0001 1101 0110</span>), reverse the order of the bits (<span class="accent">0110 1011 1000 1001</span>), cut it in "packets" of seven bits (<span class="accent">0110101 1100010 0100000</span>) then add the continuation bit to each packet (<span class="accent">10110101 11100010 00100000</span>, or <span class="accent">0xB5E220</span>).
...
To this end, many binary-to-text encodings have been created such as base64 which uses all alphanumeric characters as well as the + and / signs (<span class="accent">[A-Za-z0-9+/]</span> if you like regexes) and where each character represents 6 bits of data (<span class="accent">2^6 = 64</span>).
...
\<<span class="purple">hr-mbc</span>>-\<<span class="green">hr-cid-version</span>>-\<<span class="blue">hr-mc</span>>-\<<span class="red">hr-mh</span>>

with:

- <span class="purple">hr-mbc</span>: the multibase code
- <span class="green">hr-cid-version</span>: the CID version
- <span class="blue">hr-mc</span>: the multicodec code for the multihash's
  encoding
- <span class="red">hr-mh</span>: the multihash Obviously each of these
...
\<<span class="purple">mb-prefix</span>>\<<span class="green">cid-version</span>>\<<span class="blue">mc-ct</span>>\<<span class="red">mh-ca</span>>

with:

- <span class="purple">mb-prefix</span> ([multibase code](#multibase)): the multibase
  prefix
- <span class="green">cid-version</span> ([unsigned varint](#unsigned-varint)): the
  CID version (here 1)
- <span class="blue">mc-ct</span> ([multicodec code](#multicodec)): the format of
  the data referred to by the CID
- <span class="red">mh-ca</span> ([multihash](#multihash)): the hash of the referred
  data.
...
- **encoding**: the way data is stored in a medium.
  For an unsigned integer stored as text, you could encode it using its binary (<span class="accent">0b00101010</span>), decimal(<span class="accent">0d42</span>) or hexadecimal (<span class="accent">0x2a</span>) representation.
